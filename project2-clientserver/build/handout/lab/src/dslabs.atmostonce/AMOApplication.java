...
public final class AMOApplication<T extends Application>
    ...
    public AMOResult execute(Command command) {
        ...
        if (alreadyExecuted(amoCommand)) {return map.get(amoCommand.client());}

        Result result = application.execute(amoCommand.command());
        AMOResult amoResult = new AMOResult(amoCommand.sequenceNum(), result);
        map.put(amoCommand.client(), amoResult);
        return amoResult;
    }
