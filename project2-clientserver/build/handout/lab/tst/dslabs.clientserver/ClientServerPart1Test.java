...
public final class ClientServerPart1Test extends ClientServerBaseTest {
    ...
    @Test(timeout = 2 * 1000)
    @PrettyTestName("Test for AMOApplication deep copy")
    @TestPointValue(10)
    public void test06AMODeepCopy()
            throws InvocationTargetException, NoSuchMethodException,
            InstantiationException, IllegalAccessException {
        KVStore kvStore = new KVStore();
        kvStore.execute(new KVStore.Put("FOO", "BAR"));
        AMOApplication<KVStore> application = new AMOApplication<>(kvStore);
        AMOApplication replica = new AMOApplication(application);
